...
public class GerenciadorCargo {
	...
	public boolean verficarExistencia(String funcao, Tipo tipo){
		for(Cargo c:cargos){
	...
	public boolean validarCamposBranco(String funcao, Tipo tipo, double salario,
			int cargaHoraria) {
